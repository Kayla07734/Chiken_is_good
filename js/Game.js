class Game {
  ...
  handleElements() {
    ...
    this.leadeboardTitle.position(400, 70);
  ...
  showLeaderboard() {
    ...
    if (players[1].rank === 1) {
      ...
      myLeader2 = players[2].rank + "&emsp;"+players[2].name + "&emsp;"+players[2].score;
    }
...
showCoinsBar(){
  push()
image(lifeImg,width/2-130,height-player.positionY-140,20,20)
fill("white")
